...
AND (pcs.mettol BETWEEN to_date('1950-01-01', 'yyyy-mm-dd') AND to_date('2021-12-31', 'yyyy-mm-dd'))
AND (nvl(pcs.meddig, to_date('2021-12-31', 'yyyy-mm-dd')) BETWEEN to_date('2021-01-01', 'yyyy-mm-dd') AND to_date('2021-12-31', 'yyyy-mm-dd'))
ORDER BY fe.idopont;
